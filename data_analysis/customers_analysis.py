...
def visualize_customers_distribution_per_state(customer_df: pd.DataFrame, figsize: Tuple[int, int] = None):
    ...
    """
    # TODO: improve the visualization: title, better labels, more aesthetic
    # TODO: possibly display the distribution of both all customers and those who order at least twice on the same plot
